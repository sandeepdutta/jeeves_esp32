...
ARG IDF_CLONE_BRANCH_OR_TAG=v5.2.3
...
# install pre-reqs for micro-ROS
RUN apt-get update && \
    apt-get install -y python3-pip && \
    /bin/bash -c "source $IDF_PATH/export.sh && pip3 install catkin_pkg lark-parser empy colcon-common-extensions empy==3.3.4"
